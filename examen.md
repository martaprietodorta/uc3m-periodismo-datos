...
## 2.  Cuando hablamos de periodismo o visualización de datos, ¿a qué datos nos referimos? Razona la respuesta.
...
## 3. Qué lenguajes informáticos conoces. Razona la respuesta.
...
## 5.  ¿Qué relación tiene el formato CSV con Excel?
...
## 6.  ¿Qué tipos de formatos de datos hay? ¿Que similitudes y diferencias tienen?
...
## 7. ¿Qué programas se pueden utilizar para usar la terminal en Windows?
...
## 8. ¿Qué programa sirve para gestionar programas en la terminal de OSX?
...
## 10. ¿Qué tipo de dato de fecha elegirías para tus archivos? Razona tu respuesta.
...
## 11. ¿Cuál es la diferencia entre Internet y la Web? . Razona la respuesta.
...
## 12. Qué son las entidades HTML y cómo se representan. Por un ejemplo
...
## 13. Pon un ejemplo de uso de “wildcards”
...
## 14. ¿Qué función tiene la almohadilla en Markdown y en un programa de la shell? Razona tu respuesta.
...
## 15. Elige una URL de una noticia de un medio de comunicación y explícala tal como hicimos en clase.
...
## 16. ¿Qué es la visualización de datos? Aporta tus impresiones sobre el debate.
...
## 17. ¿Qué medio de comunicación inglés es fundamental en el periodismo y la visualización de datos? 
The Guardian, puesto que fue uno de los primeros medios en aplicar el periodismo de datos moderno.  

## 18.  ¿Qué fue determinante para el nacimiento del periodismo de datos moderno?
...
## 19. Qué saberes están implicados en periodismo de datos. Razona la respuesta.
...
## 22. Pon un par de ejemplos de Google Dorks u "operadores de búsqueda”
...
## 23. ¿Qué significa el funcionamiento “cliente-servidor”?
...
## 24.  ¿En qué se diferencian las rutas absolutas de las relativas? Pon ejemplos de ambas.
...
## 25. ¿Qué hay que hacer para ver el valor de la variable de entorno de shell "PATH" con el comando “echo"?

echo $PATH, donde el símbolo del dólar indica que se trata de una variable 

## 26. Si quisieras clonar un repositorio git, ¿qué pasos tendrías que dar? ¿Cómo comprobarías que ha funcionado?
...
## 27.  Si quisieras ver la web theguardian.com, ¿cómo lo harías desde la línea de comandos?
...
## 28. ¿Cómo te descargarías la web theguardian.com desde la línea de comandos?

Con el comando WGET 

## 29. ¿Dónde se guarda la configuración de tu shell? ¿Cuál es tu versión?

cat /etc/shells Yo (Mac) uso zsh 

## 30. ¿Qué comandos o expresiones le pasarías a =lolcat=? Pon un ejemplo.

# ps | lolcat  # date | lolcat # cal | lolcat 

## 31. ¿Cuál es la estructura de las sentencias/instrucciones en la línea de comandos?	

	- Poner el comando solo, como por ejemplo: pwd.
	-  Argumentos, como por ejemplo listar un directorio: ls uc3m-periodismo-datos  

## 32. ¿Qué tipos de archivos de documentos de texto conoces?
...
## 33.  ¿Qué tres tecnologías componen una página web?

URL Unified Resource Locator o localizador de recursos uniformes es la dirección web,  junto con el hipertexto (expresado en HTML) y HTTP, protocolo de transmisión se utiliza para indicar el protocolo usado, debe llevar la S de segura, son conceptos clave para la web. 



## 34. ¿Quién es Philip Meyer?
...
## 35. ¿Quién fue Florence Nightingale?
